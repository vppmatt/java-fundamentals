...
import com.multicode.expenses.utilities.EmployeeUtilities;
...
public class Main {
    public static void main(String[] args) {
        ...
        ExpenseClaim claim1 = new ExpenseClaim(1,3,new Date(), 16.30);
        ExpenseClaim claim2 = new ExpenseClaim(2,3,new Date(), 37.50);
