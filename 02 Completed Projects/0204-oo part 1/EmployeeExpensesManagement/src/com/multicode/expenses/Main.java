...
public class Main {
    public static void main(String[] args) {
        ...
        TravelExpenseItem item1 = new TravelExpenseItem(172,1,"London to Paris", new BigDecimal("155"),"Train");
        AccomodationExpenseItem item2 = new AccomodationExpenseItem(173,1,"The Hilton, Paris", new BigDecimal("360"),"Hotel");
