...
public class Employee {
    ...
    public boolean equals(Object o) {
        ...
        return id == employee.id &&
                ...
                nextExpenseClaimPosition == employee.nextExpenseClaimPosition &&
                Objects.equals(title, employee.title) &&
                Objects.equals(firstName, employee.firstName) &&
                Objects.equals(surname, employee.surname) &&
                Objects.equals(jobTitle, employee.jobTitle) &&
                Objects.equals(department, employee.department) &&
                Arrays.equals(expenseClaims, employee.expenseClaims);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(id, title, firstName, surname, jobTitle, department, active, nextExpenseClaimPosition);
        result = 31 * result + Arrays.hashCode(expenseClaims);
        return result;
    }
    ...
    public String toString() {
        return "Employee{" +
                ...
                ", active=" + active +
                ", expenseClaims=" + Arrays.toString(expenseClaims) +
                ", nextExpenseClaimPosition=" + nextExpenseClaimPosition +
                '}';
    }
}
