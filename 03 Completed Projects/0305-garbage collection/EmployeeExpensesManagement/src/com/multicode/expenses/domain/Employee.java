...
public class Employee {
    ...
    public String getMailingName() {
        StringBuilder mailingName = new StringBuilder();
        mailingName.append(title).append(" ").append(firstName).append(" ").append(surname);
        return mailingName.toString();
    }

    public String getMailingName(boolean initialOnly) {
        StringBuilder mailingName = new StringBuilder();
        mailingName.append(title).append(" ");
        if (initialOnly) {
            mailingName.append(firstName.substring(0,1));
        }
        else {
            mailingName.append(firstName);
        }
        mailingName.append(" ").append(surname);
        return mailingName.toString();
    }
